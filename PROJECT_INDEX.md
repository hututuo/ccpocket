...
|---|---|---|---|---|
| `plans/conversation-sync-stability_v01_20260806-160058.md` / `fix/conversation-sync-stability-20260806` | Active stability plan and isolated worktree | Make conversation open/load/retry/live persistence/cache monotonicity/runtime continuity/scroll behavior reliable before structural cleanup | No | `active / investigation-first`; base `98d48ecc…`; Luna Max read-only exploration followed by root review; production/release/device unchanged |
