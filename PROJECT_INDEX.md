...
|---|---|---|---|---|
| `plans/full-architecture-review-remediation_v01_20260807-071715.md` / `fix/architecture-review-remediation-20260807` | Active Review remediation plan and implementation line | Reclassify the external architecture Review against real call conditions, selectively absorb useful upstream performance work, then repair shared-writer UX, retry, incomplete windows, provider backoff and runtime turn fencing | No | `active`; base `b61597e9`; upstream `8c075b33` accepted for semantic integration, `4bb3d2e3` omitted; production/release/device unchanged |
