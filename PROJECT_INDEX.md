...
| `f1d18745` | Codex project policy correction | Use on-request review, auto-allow deterministic build/test commands, and retain prompts for arbitrary scripts/deploy/publish/remote actions | No | execpolicy smoke: Bridge build/test and iOS build allow; Cloud deploy, Shorebird promote, arbitrary Node and Git push prompt |
