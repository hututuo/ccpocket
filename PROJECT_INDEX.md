...
| `notes/codex-shared-runtime-stage2-pilot-evidence_v01_20260801-014302.md` | Automated Pilot evidence | Record isolated daemon, two-client L0, neutral resume, Bridge restart continuity, active-turn adoption, tests and hard-stop boundary | No | `automated-pilot-passed`; candidate `1.69.6-compat.12` on `127.0.0.1:18765`, awaiting user-observed Desktop gate; production unchanged |
