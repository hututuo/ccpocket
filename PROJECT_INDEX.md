...
|---|---|---|---|---|
| `plans/codex-shared-runtime-warm-switch_v01_20260731-230240.md` | Draft implementation plan | Preserve the full shared Codex daemon and warm-switch design while moving a reversible Bridge/Desktop sidebar experiment ahead of full implementation | No | `draft`; independent worktree/branch created; no source, service, OTA, or IPA changes |
