...
|---|---|---|---|---|
| `notes/conversation-retry-cache-rewind_v01_20260807-094748.md` / pending source commit | Field regression root-cause and source correction | Separate older-history retry from latest-turn repair, serialize cache mutations, reject stale preview reads, and preserve live output across provisional source/runtime reconciliation | No | `source-verified / release-pending / physical-device-pending`; Mobile 239 targeted tests, analyze 0 error/warning plus 2 existing infos; Dart-only |
