...
|---|---|---|---|---|
| `notes/codex-dual-path-full-chain-audit_v01_20260801-022457.md` | Full-chain dual-path audit | Trace Desktop-origin and Bridge-origin Codex turns through app-server, Bridge, v2, SQLite and Mobile UI before remediation | No | `audit-complete / remediation-active`; consolidated `0 P0 / 12 P1 / 6 P2 / 1 P3`; source repair authorized, production/release gates unchanged |
| `plans/codex-shared-runtime-warm-switch_v01_20260731-230240.md` | Active implementation plan | Preserve the full shared Codex daemon and warm-switch design while moving a reversible Bridge/Desktop sidebar experiment ahead of full implementation | No | `active`; Stage 0–2 only until the user-observed pilot hard stop |
| `notes/codex-shared-runtime-stage0-deviation-ledger_v01_20260731-234929.md` | Active exploration ledger | Map plan assumptions to exact target binary, Desktop bundle, Bridge source and runtime evidence before implementation | No | `active`; production 8765, Mobile, OTA, IPA and system network configuration untouched |
| `notes/codex-shared-runtime-stage2-pilot-evidence_v01_20260801-014302.md` | Automated Pilot evidence | Record isolated daemon, two-client L0, neutral resume, Bridge restart continuity, active-turn adoption, final request/transaction/backend hardening, tests and hard-stop boundary | No | `automated-pilot-passed`; `2039/2039` full tests plus post-hardening real turn passed; candidate `1.69.6-compat.12` on `127.0.0.1:18765`, awaiting strictly no-tool user-observed Desktop gate; production unchanged |
