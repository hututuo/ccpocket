...
to V8. It leaves every V7/V6/V5 file untouched, rejects explicitly supplied legacy
...
ConversationRepository.open
  -> choose V8 path; reject known V7/V6/V5/V4/legacy identities
  -> sqflite open with schema version 8
...
commitRuntimeProjections
  ...
  -> one admission transaction
       ...
       -> historical terminal replay neither recreates nor drives publication
...
| `conversation_repository_schema.dart` | V8 DDL, semantic schema attestation, triggers/indexes/FKs/checks, writer lease, key predicates | Called during open and before every serialized mutation through lease assertions |
...
- V8 uses `conversation_replica_v8.db` and schema identity
  `ccpocket.conversation_replica_v8`. Existing V7/V6/V5 files remain byte-for-byte
  untouched; explicitly supplied V7/V6/V5/V4/legacy paths and schema upgrades are
...
2. Review the V8/V7/V6/V5 identity boundary, semantic schema attestation, and writer lease.
