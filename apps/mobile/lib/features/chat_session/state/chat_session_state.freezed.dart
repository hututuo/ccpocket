...
// normal mobile queue/edit/cancel behavior stays available.
 ...
 ExecutionMode get executionMode;// Whether the Codex permission fields below came from the Bridge/provider
...
// an older/sparse Bridge did not supply permission metadata.
 bool get codexPermissionStateKnown; CodexApprovalPolicy get codexApprovalPolicy; String get codexApprovalsReviewer; CodexPermissionsMode get codexPermissionsMode; String? get codexModel; ReasoningEffort? get codexModelReasoningEffort; CodexSpeed get codexSpeed; bool get planMode; CodexNativePlanModeSupport get codexNativePlanModeSupport;// Sandbox mode - Freezed default is .on but Cubit constructor overrides
...
as ExecutionMode,codexPermissionStateKnown: null == codexPermissionStateKnown ? _self.codexPermissionStateKnown : codexPermissionStateKnown // ignore: cast_nullable_to_non_nullable
as bool,codexApprovalPolicy: null == codexApprovalPolicy ? _self.codexApprovalPolicy : codexApprovalPolicy // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ChatSessionState() when $default != null:
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.explorerCurrentPath,_that.recentPeekedFiles,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.sessionUnavailable,_that.externalDesktopTurnActive,_that.externalDesktopTurnId,_that.permissionMode,_that.executionMode,_that.codexPermissionStateKnown,_that.codexApprovalPolicy,_that.codexApprovalsReviewer,_that.codexPermissionsMode,_that.codexModel,_that.codexModelReasoningEffort,_that.codexSpeed,_that.planMode,_that.codexNativePlanModeSupport,_that.sandboxMode,_that.hiddenToolUseIds,_that.rewindPreview,_that.totalCost,_that.totalDuration,_that.slashCommands,_that.queuedInput,_that.goal,_that.goalStateLoaded,_that.goalSupport,_that.advancedGoalControlSupported,_that.goalOperationSequence,_that.goalMutation,_that.goalMutationError,_that.goalMutationErrorKind,_that.goalLoadErrorKind);case _:
  return orElse();
...
// compatibility, but must not be presented or written back as facts when
// an older/sparse Bridge did not supply permission metadata.
@override@JsonKey() final  bool codexPermissionStateKnown;
