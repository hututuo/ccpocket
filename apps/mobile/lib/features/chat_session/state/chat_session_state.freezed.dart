...
@override
int get hashCode => Object.hashAll([runtimeType,status,const DeepCollectionEquality().hash(_entries),approval,claudeSessionId,projectPath,gitBranch,explorerCurrentPath,const DeepCollectionEquality().hash(_recentPeekedFiles),pastHistoryLoaded,bulkLoading,inPlanMode,collapseToolResults,permissionMode,executionMode,codexApprovalPolicy,codexApprovalsReviewer,codexPermissionsMode,codexModel,codexModelReasoningEffort,codexSpeed,planMode,sandboxMode,const DeepCollectionEquality().hash(_hiddenToolUseIds),rewindPreview,totalCost,totalDuration,const DeepCollectionEquality().hash(_slashCommands),queuedInput,goal,goalStateLoaded,goalSupport,advancedGoalControlSupported,goalOperationSequence,goalMutation,goalMutationError,goalMutationErrorKind,goalLoadErrorKind]);
