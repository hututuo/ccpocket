...
/// after debounce).
 String get searchQuery;/// Presentation grouping selected in the Mobile UI.
///
...
/// filesystem paths. Legacy groups continue to store the raw path here.
 String? get selectedProjectKey;/// Accumulated project paths from all loaded sessions + project history.
...
as String,selectedProjectKey: freezed == selectedProjectKey ? _self.selectedProjectKey : selectedProjectKey // ignore: cast_nullable_to_non_nullable
...
/// Desktop project IDs are intentionally not sent to legacy Bridge APIs as
/// filesystem paths. Legacy groups continue to store the raw path here.
@override final  String? selectedProjectKey;
