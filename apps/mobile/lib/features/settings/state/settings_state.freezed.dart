...
/// Empty string means use device default.
 ...
 FcmStatusKey? get fcmStatusKey;/// Local and remote notification categories selected on this device.
 NotificationPreferences get notificationPreferences;/// Shorebird update track ('stable' or 'staging').
 ...
 bool get autoRenameCodexSessions;/// Whether Max and Ultra appear in Codex Effort sliders when supported.
 bool get showExtendedCodexEfforts;/// Whether new Claude sessions should be automatically named after the first turn.
...
@useResult
$Res call({
 ThemeMode themeMode, String appLocaleId, String speechLocaleId, Set<String> fcmEnabledMachines, Set<String> fcmPrivacyMachines, String? activeMachineId, bool fcmAvailable, bool fcmSyncInProgress, FcmStatusKey? fcmStatusKey, NotificationPreferences notificationPreferences, String shorebirdTrack, int indentSize, double textScale, double codeFontSize, CodeFontFamily codeFontFamily, bool hideVoiceInput, ImagePasteShortcut imagePasteShortcut, GitDiffInteractionMode gitDiffInteractionMode, bool gitDiffFocusAutoLandscape, bool showRemoteGitStatusBadge, bool showBridgeNameInSessionList, AppIconVariant selectedAppIcon, bool appIconSupported, TerminalAppConfig terminalApp, List<NewSessionTab> newSessionTabs, UsageDisplayMode usageDisplayMode, bool autoRenameCodexSessions, bool showExtendedCodexEfforts, bool autoRenameClaudeSessions
});
...
as FcmStatusKey?,notificationPreferences: null == notificationPreferences ? _self.notificationPreferences : notificationPreferences // ignore: cast_nullable_to_non_nullable
as NotificationPreferences,shorebirdTrack: null == shorebirdTrack ? _self.shorebirdTrack : shorebirdTrack // ignore: cast_nullable_to_non_nullable
...
as bool,showExtendedCodexEfforts: null == showExtendedCodexEfforts ? _self.showExtendedCodexEfforts : showExtendedCodexEfforts // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode themeMode,  String appLocaleId,  String speechLocaleId,  Set<String> fcmEnabledMachines,  Set<String> fcmPrivacyMachines,  String? activeMachineId,  bool fcmAvailable,  bool fcmSyncInProgress,  FcmStatusKey? fcmStatusKey,  NotificationPreferences notificationPreferences,  String shorebirdTrack,  int indentSize,  double textScale,  double codeFontSize,  CodeFontFamily codeFontFamily,  bool hideVoiceInput,  ImagePasteShortcut imagePasteShortcut,  GitDiffInteractionMode gitDiffInteractionMode,  bool gitDiffFocusAutoLandscape,  bool showRemoteGitStatusBadge,  bool showBridgeNameInSessionList,  AppIconVariant selectedAppIcon,  bool appIconSupported,  TerminalAppConfig terminalApp,  List<NewSessionTab> newSessionTabs,  UsageDisplayMode usageDisplayMode,  bool autoRenameCodexSessions,  bool showExtendedCodexEfforts,  bool autoRenameClaudeSessions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.themeMode,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.notificationPreferences,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.codeFontSize,_that.codeFontFamily,_that.hideVoiceInput,_that.imagePasteShortcut,_that.gitDiffInteractionMode,_that.gitDiffFocusAutoLandscape,_that.showRemoteGitStatusBadge,_that.showBridgeNameInSessionList,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.usageDisplayMode,_that.autoRenameCodexSessions,_that.showExtendedCodexEfforts,_that.autoRenameClaudeSessions);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode themeMode,  String appLocaleId,  String speechLocaleId,  Set<String> fcmEnabledMachines,  Set<String> fcmPrivacyMachines,  String? activeMachineId,  bool fcmAvailable,  bool fcmSyncInProgress,  FcmStatusKey? fcmStatusKey,  NotificationPreferences notificationPreferences,  String shorebirdTrack,  int indentSize,  double textScale,  double codeFontSize,  CodeFontFamily codeFontFamily,  bool hideVoiceInput,  ImagePasteShortcut imagePasteShortcut,  GitDiffInteractionMode gitDiffInteractionMode,  bool gitDiffFocusAutoLandscape,  bool showRemoteGitStatusBadge,  bool showBridgeNameInSessionList,  AppIconVariant selectedAppIcon,  bool appIconSupported,  TerminalAppConfig terminalApp,  List<NewSessionTab> newSessionTabs,  UsageDisplayMode usageDisplayMode,  bool autoRenameCodexSessions,  bool showExtendedCodexEfforts,  bool autoRenameClaudeSessions)  $default,) {final _that = this;
switch (_that) {
case _SettingsState():
return $default(_that.themeMode,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.notificationPreferences,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.codeFontSize,_that.codeFontFamily,_that.hideVoiceInput,_that.imagePasteShortcut,_that.gitDiffInteractionMode,_that.gitDiffFocusAutoLandscape,_that.showRemoteGitStatusBadge,_that.showBridgeNameInSessionList,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.usageDisplayMode,_that.autoRenameCodexSessions,_that.showExtendedCodexEfforts,_that.autoRenameClaudeSessions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode themeMode,  String appLocaleId,  String speechLocaleId,  Set<String> fcmEnabledMachines,  Set<String> fcmPrivacyMachines,  String? activeMachineId,  bool fcmAvailable,  bool fcmSyncInProgress,  FcmStatusKey? fcmStatusKey,  NotificationPreferences notificationPreferences,  String shorebirdTrack,  int indentSize,  double textScale,  double codeFontSize,  CodeFontFamily codeFontFamily,  bool hideVoiceInput,  ImagePasteShortcut imagePasteShortcut,  GitDiffInteractionMode gitDiffInteractionMode,  bool gitDiffFocusAutoLandscape,  bool showRemoteGitStatusBadge,  bool showBridgeNameInSessionList,  AppIconVariant selectedAppIcon,  bool appIconSupported,  TerminalAppConfig terminalApp,  List<NewSessionTab> newSessionTabs,  UsageDisplayMode usageDisplayMode,  bool autoRenameCodexSessions,  bool showExtendedCodexEfforts,  bool autoRenameClaudeSessions)?  $default,) {final _that = this;
switch (_that) {
case _SettingsState() when $default != null:
return $default(_that.themeMode,_that.appLocaleId,_that.speechLocaleId,_that.fcmEnabledMachines,_that.fcmPrivacyMachines,_that.activeMachineId,_that.fcmAvailable,_that.fcmSyncInProgress,_that.fcmStatusKey,_that.notificationPreferences,_that.shorebirdTrack,_that.indentSize,_that.textScale,_that.codeFontSize,_that.codeFontFamily,_that.hideVoiceInput,_that.imagePasteShortcut,_that.gitDiffInteractionMode,_that.gitDiffFocusAutoLandscape,_that.showRemoteGitStatusBadge,_that.showBridgeNameInSessionList,_that.selectedAppIcon,_that.appIconSupported,_that.terminalApp,_that.newSessionTabs,_that.usageDisplayMode,_that.autoRenameCodexSessions,_that.showExtendedCodexEfforts,_that.autoRenameClaudeSessions);case _:
  return null;
...
class _SettingsState extends SettingsState {
  const _SettingsState({this.themeMode = ThemeMode.system, this.appLocaleId = '', this.speechLocaleId = '', final  Set<String> fcmEnabledMachines = const {}, final  Set<String> fcmPrivacyMachines = const {}, this.activeMachineId, this.fcmAvailable = false, this.fcmSyncInProgress = false, this.fcmStatusKey, this.notificationPreferences = NotificationPreferences.defaults, this.shorebirdTrack = 'stable', this.indentSize = 2, this.textScale = 1.0, this.codeFontSize = 12.0, this.codeFontFamily = CodeFontFamily.jetBrainsMono, this.hideVoiceInput = false, this.imagePasteShortcut = ImagePasteShortcut.ctrlV, this.gitDiffInteractionMode = GitDiffInteractionMode.quickActions, this.gitDiffFocusAutoLandscape = false, this.showRemoteGitStatusBadge = false, this.showBridgeNameInSessionList = true, this.selectedAppIcon = AppIconVariant.defaultIcon, this.appIconSupported = false, this.terminalApp = TerminalAppConfig.empty, final  List<NewSessionTab> newSessionTabs = defaultNewSessionTabs, this.usageDisplayMode = UsageDisplayMode.remaining, this.autoRenameCodexSessions = true, this.showExtendedCodexEfforts = true, this.autoRenameClaudeSessions = false}): _fcmEnabledMachines = fcmEnabledMachines,_fcmPrivacyMachines = fcmPrivacyMachines,_newSessionTabs = newSessionTabs,super._();
...
@override@JsonKey() final  bool showExtendedCodexEfforts;
...
@override
int get hashCode => Object.hashAll([runtimeType,themeMode,appLocaleId,speechLocaleId,const DeepCollectionEquality().hash(_fcmEnabledMachines),const DeepCollectionEquality().hash(_fcmPrivacyMachines),activeMachineId,fcmAvailable,fcmSyncInProgress,fcmStatusKey,notificationPreferences,shorebirdTrack,indentSize,textScale,codeFontSize,codeFontFamily,hideVoiceInput,imagePasteShortcut,gitDiffInteractionMode,gitDiffFocusAutoLandscape,showRemoteGitStatusBadge,showBridgeNameInSessionList,selectedAppIcon,appIconSupported,terminalApp,const DeepCollectionEquality().hash(_newSessionTabs),usageDisplayMode,autoRenameCodexSessions,showExtendedCodexEfforts,autoRenameClaudeSessions]);
