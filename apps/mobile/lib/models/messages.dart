...
class UserChatEntry implements ChatEntry {
  ...
  /// Stable provider item identity. Unlike [messageUuid], this is never a
  /// page-local synthetic turn count.
  final String? providerItemId;

  /// Provider turn provenance for stable process grouping and targeted loads.
  final String? historyTurnId;
