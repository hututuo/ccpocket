...
class BridgeService implements BridgeServiceBase {
  ...
  String? get cacheBridgeInstanceIdHint =>
      bridgeInstanceId ?? _cacheBridgeInstanceIdHint;

  /// Source identity paired with [cacheBridgeInstanceIdHint].
  String? get cacheCodexSourceIdHint =>
      bridgeInstanceId != null ? codexSourceId : _cacheCodexSourceIdHint;
  ...
  bool get supportsConversationUserIndex =>
      _bridgeCapabilities.contains(conversationUserIndexCapability);
